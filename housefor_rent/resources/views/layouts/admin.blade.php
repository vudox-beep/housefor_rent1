...
<head>
    ...
    <title>Admin Panel - {{ config('app.name', 'HouseForRent') }}</title>
    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-menu">
                ...
                <a href="{{ route('admin.dealers') }}" class="menu-item {{ request()->routeIs('admin.dealers') ? 'active' : '' }}">
        ...
        <main class="main-content">
            <header class="top-header">
                ...
                <div class="user-profile">
                    ...
                    <img src="https://ui-avatars.com/api/?name=Admin&background=random" alt="Admin" class="user-avatar">
                </div>
            </header>
